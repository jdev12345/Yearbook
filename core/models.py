...
class Profile(models.Model):
    ...
    profile_pic = models.ImageField(upload_to='static/profile_pics/', default='static/profile_pics/no-profile-pic.png')
...
class Team_Member(models.Model):
    ...
    profile_pic = models.ImageField(upload_to='team/', default='static/profile_pics/no-profile-pic.png')
